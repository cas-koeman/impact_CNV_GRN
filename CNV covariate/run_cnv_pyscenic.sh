#!/bin/bash
#SBATCH --error=cnv_scenic.err
#SBATCH --output=cnv_scenic.out
#SBATCH -J cnv_scenic
#SBATCH -p slim16
#SBATCH --ntasks=4
...
SAMPLE_ID="C3L-01313-T1_CPT0086820004" #C3N-00495-T1_CPT0078510004 #C3L-00004-T1_CPT0001540013 #C3L-00917-T1_CPT0023690004
...
for CELL_TYPE in "${CELL_TYPES[@]}"; do
    for PRUNE in "${PRUNE_FLAGS[@]}"; do
        ...
        python cnv_pyscenic.py "$BASE_FOLDER" "$DATA_FOLDER" "$DATASET_ID" "$SAMPLE_ID" --cell_type "$CELL_TYPE" --prune "$PRUNE"
